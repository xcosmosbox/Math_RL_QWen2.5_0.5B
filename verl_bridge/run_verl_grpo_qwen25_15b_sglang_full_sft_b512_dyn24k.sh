...
LOG_FILE="${LOG_FILE:-$LOG_DIR/${TIMESTAMP}_qwen25_15b_grpo_full_sftmerged_sglang_b512_dyn24k.log}"
...
EXPERIMENT_NAME=qwen25_15b_grpo_full_sftmerged_sglang_b512_dyn24k_u08 \
OUTPUT_DIR="$ROOT_DIR/outputs/verl/qwen25_15b_grpo_full_sftmerged_sglang_b512_dyn24k_u08" \
...
ACTOR_PPO_MAX_TOKEN_LEN_PER_GPU=24000 \
LOGPROB_MAX_TOKEN_LEN_PER_GPU=24000 \
