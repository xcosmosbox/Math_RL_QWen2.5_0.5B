...
LOG_FILE="${LOG_FILE:-$LOG_DIR/${TIMESTAMP}_qwen25_15b_grpo_full_sftmerged_sglang_b512_micro16.log}"
...
EXPERIMENT_NAME=qwen25_15b_grpo_full_sftmerged_sglang_b512_micro16_u08 \
OUTPUT_DIR="$ROOT_DIR/outputs/verl/qwen25_15b_grpo_full_sftmerged_sglang_b512_micro16_u08" \
